...
type Person_PhoneNumber struct {
	...
	Type          PhoneType              `protobuf:"varint,2,opt,name=type,proto3,enum=go_proto.v1.PhoneType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_addressbook_proto_rawDesc = "" +
	"\n" +
	"\x11addressbook.proto\x12\vgo_proto.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8d\x02\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x127\n" +
	"\x06phones\x18\x04 \x03(\v2\x1f.go_proto.v1.Person.PhoneNumberR\x06phones\x12=\n" +
	"\flast_updated\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x1aQ\n" +
	"\vPhoneNumber\x12\x16\n" +
	"\x06number\x18\x01 \x01(\tR\x06number\x12*\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.go_proto.v1.PhoneTypeR\x04type\":\n" +
	"\vAddressBook\x12+\n" +
	"\x06people\x18\x01 \x03(\v2\x13.go_proto.v1.PersonR\x06people*h\n" +
	"\tPhoneType\x12\x1a\n" +
...
var file_addressbook_proto_goTypes = []any{
	(PhoneType)(0),                // 0: go_proto.v1.PhoneType
	(*Person)(nil),                // 1: go_proto.v1.Person
	(*AddressBook)(nil),           // 2: go_proto.v1.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: go_proto.v1.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	3, // 0: go_proto.v1.Person.phones:type_name -> go_proto.v1.Person.PhoneNumber
	4, // 1: go_proto.v1.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: go_proto.v1.AddressBook.people:type_name -> go_proto.v1.Person
	0, // 3: go_proto.v1.Person.PhoneNumber.type:type_name -> go_proto.v1.PhoneType
